    ...
    function displayProducts(productsToShow) {
        ...
        productsToShow.forEach(product => {
            ...
            row.innerHTML = `
                ...
                <td class="border border-gray-300 p-2 ${product.quantity <= LOW_STOCK_THRESHOLD ? 'text-red-600 font-semibold' : ''}">
                    ${product.quantity}
                </td>
        ...
        restockBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                if (product) {
                    ...
                    // Update modal title
                    document.querySelector('#restockModal h3').textContent = `Restock ${product.name}`;
